...
define(function(require, exports, module) {
    ...
    exports.planDragSave = function() {
        ...
        //新增表记录的时候添加班次
    exports.bcglAddPlanDefine = function(bcmc) {
    ...
    exports.getPlanOrder=function() {
		...
		queryFilter.orderByString = "OBJECTID DESC"; // and USER_ZB=3*/
		$.ajax({
        ...
        .done(function(result) {
            if (!result.length) {
		        ...
		        bcglBuildOrderHtml(result[0].planItem);
		    }
        })
        .fail(function() {
            console.log("error");
	...
	function bcglBuildOrderHtml(planItem) {
